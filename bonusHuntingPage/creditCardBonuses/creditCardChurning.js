document.addEventListener("DOMContentLoaded", function () {
    ...
    // const ChaseAmazonPrimeWholeFoodsImage = document.getElementById("ChaseAmazonPrimeWholeFoodsImage");
    ...
    {
        const url = "https://refer.discover.com/s/paulsjac000?advocate.partner_share_id=7305981829";
        window.open(url, "_blank");
    });

    ChaseAmazonPrimeImage.addEventListener("click", function () 
    {
        const url = "https://www.amazon.com/dp/BT00LN946S?externalReferenceId=42d266ea-6edf-4de9-965d-b2310af4a856";
        window.open(url, "_blank");
    });
    
    // ChaseAmazonPrimeWholeFoodsImage.addEventListener("click", function () 
    // {
    //     const url = "https://www.amazon.com/dp/BT00LN946S?externalReferenceId=42d266ea-6edf-4de9-965d-b2310af4a856";
    //     window.open(url, "_blank");
    // });
    ...
    {
        const url = "https://www.referyourchasecard.com/18N/6TC77OQ7ZM";
        window.open(url, "_blank");
    });
    ...
    {
        const url = "https://americanexpress.com/en-us/referral/blue-cash-everyday-credit-card?ref=JACKPcCuq&XL=MIMNS";
        window.open(url, "_blank");
    });

    HiltonHonorsImage.addEventListener("click", function () 
    {
        const url = "https://www.americanexpress.com/en-us/credit-cards/referral/prospect/hilton-honors?ref=JACKPFNge&XL=MIMNS";
        window.open(url, "_blank");
    });

    AMEXGoldImage.addEventListener("click", function () 
    {
        const url = "https://americanexpress.com/en-us/referral/gold-card?ref=JACKP555t&XL=MIMNS";
        window.open(url, "_blank");
    });

    AAATravelImage.addEventListener("click", function () 
    {
        const url = "https://northeast.aaa.com/financial/more-products/aaa-visa-travel-advantage-card.html";
        window.open(url, "_blank");
    });

    CitiCustomCashImage.addEventListener("click", function () 
    {
        const url = "https://www.citi.com/usc/LPACA/Citi/Cards/CustomCash/ps/index.html?cmp=knc|acquire|2006|CARDS|Google|BR&gclid=EAIaIQobChMI-pjhiqipigMVhTcIBR1qWSOVEAAYASAAEgK7pvD_BwE&gclsrc=aw.ds&ProspectID=PnCOpK25M12FDsQsgRq0oKPHmg2gOtiS";
        window.open(url, "_blank");
    });

    AMEXHiltonSurpassImage.addEventListener("click", function () 
    {
        const url = "https://www.americanexpress.com/us/credit-cards/card/hilton-honors-surpass/?eep=25330&intlink=US-Axp-Shop-Consumer-VAC-HiltonSurpass-Prospect-Cardname-CardTile&inav=menu_cards_pc_travelrewardscards";
        window.open(url, "_blank");
    });

    RobinhoodGoldCardImage.addEventListener("click", function () 
    {
        const url = "https://robinhood.com/creditcard/";
        window.open(url, "_blank");
    });
